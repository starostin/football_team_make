...
(function (document, window) {
    ...
    function preventBodyTouch(e) {
        ...
        if (tracker.scrollRequest &&  ((e.touches[0].screenY > tracker.startIOSTouch && tracker.scrollView.scrollTop === 0) || (tracker.scrollView.scrollTop >= tracker.scrollEnd && e.touches[0].screenY < tracker.startIOSTouch))) {
            e.preventDefault();
        }
        tracker = null;
    }
...
RAD.namespace('RAD.Blanks.Toast', RAD.Blanks.View.extend({
    ...
    oninit: function () {
        ...
        self.refreshTimeout = function () {
            console.log('refresh: ' + this.viewID + ' ' + this.closeTimeOut);
